                    ...
                    isEditing ? (
                        <>
                            <Textarea
                                className='mb-2'
                                maxLength='200'
                                onChange={(e) => setEditedContent(e.target.value)} value={editedContent} />
                        ...
                        (
                            <>
                                ...
                                <div className='flex items-center pt-2 text-xs border-t dark:border-gray-700 gap-2 max-w-fill'>
